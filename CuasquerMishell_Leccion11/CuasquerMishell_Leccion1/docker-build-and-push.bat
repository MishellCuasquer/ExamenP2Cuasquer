@echo off
REM Script para construir y publicar imagen en Docker Hub (Windows)
REM Support Tickets API

setlocal enabledelayedexpansion

REM Variables
set IMAGE_NAME=mishellcuasquer/support-tickets-api
set TAG=latest
...
REM Paso 1: Construir la imagen localmente
echo 1. Construyendo imagen Docker localmente...
docker build -t %FULL_IMAGE_NAME% .

REM Paso 2: Verificar la imagen
echo.
echo 2. Verificando imagen construida...
docker images | findstr %IMAGE_NAME%

REM Paso 3: Login en Docker Hub (descomentar si no estás logueado)
echo.
echo 3. Haciendo login en Docker Hub...
REM docker login

REM Paso 4: Publicar la imagen
echo.
echo 4. Publicando imagen en Docker Hub...
docker push %FULL_IMAGE_NAME%

REM Paso 5: Verificar publicación
echo.
